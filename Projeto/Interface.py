...
def criar_janela_principal(nome_user):
    ...
    sidebar_content = [
        ...
        [sg.Frame(" Parâmetros da Simulação ", [
            ...
            [sg.Text("Distribuição:", size=(12,1)), sg.Combo(["Exponencial", "Normal", "Uniforme"], key='-DIST-', default_value="Exponencial", size=(10,1), readonly=True)],
        ...
        ], pad=((0,0),(10,20)), expand_x=True, background_color='#34495e', title_color='white')],
        ...
        [sg.Frame(" Relatórios Detalhados ", [
            [sg.Button(" Log Completo", key='-LOG-', size=(23,1), disabled=True)],
            [sg.Button(" Performance Médicos", key='-TIME-', size=(23,1), disabled=True)]
        ], pad=((0,0),(0,20)), expand_x=True, background_color='#34495e', title_color='white')],
