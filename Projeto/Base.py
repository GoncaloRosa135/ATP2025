...
def simula():
    ...
    modo_catastrofe = False
    if np.random.random() < PROBABILIDADE_CATASTROFE:
        modo_catastrofe = True
    ...
    return h_tempo, h_fila, h_ocup, h_esp, h_atend, medicos, tempo_atual, h_esp_atend, historial, modo_catastrofe